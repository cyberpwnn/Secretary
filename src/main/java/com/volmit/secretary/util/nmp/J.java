package com.volmit.secretary.util.nmp;
...
public class J
{
	...
	{
		Bukkit.getScheduler().scheduleSyncDelayedTask(Secretary.vpi, r);
	}
	...
	{
		Bukkit.getScheduler().scheduleSyncDelayedTask(Secretary.vpi, r, delay);
	}
	...
	{
		return Bukkit.getScheduler().scheduleSyncRepeatingTask(Secretary.vpi, r, 0, interval);
	}
	...
	{
		Bukkit.getScheduler().scheduleAsyncDelayedTask(Secretary.vpi, r, 0);
	}
	...
	{
		Bukkit.getScheduler().scheduleAsyncDelayedTask(Secretary.vpi, r, delay);
	}
	...
	{
		return Bukkit.getScheduler().scheduleAsyncRepeatingTask(Secretary.vpi, r, 0, interval);
	}
